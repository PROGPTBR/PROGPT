  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground font-outfit antialiased flex flex-col">
      ...
      <main className="relative z-10 flex-1 grid lg:grid-cols-2 pt-[73px]">
        ...
        <aside className="relative hidden lg:flex  flex-col justify-center gap-8 overflow-hidden bg-gradient-to-br from-[#0ed1e0] via-[#0e8de1] to-[#0a6fbf] px-12 xl:px-16 py-14 text-white">
