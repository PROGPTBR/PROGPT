          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setDraft((d) => ({
                  ...d,
                  assistant_type: e.target.value as 'rfp' | 'kraljic' | 'porter' | 'financial' | 'abc' | 'profile',
                }))
              }
              disabled={!!initial}
            ...
            >
              ...
              <option value="abc">ABC / Curva de Pareto</option>
              <option value="profile">Perfil / Caracterização da Categoria</option>
            </select>
            {initial && (
