...
**Test count atual:** 854 vitest, 28 pytest, typecheck zero erros. CI gate: `recall@5 ≥ 0.85` em PR + push main.
...
> `lib/email/*`, `lib/legal/*`, `lib/suppliers/*`, `lib/captcha.ts`; `app/assistants/*` (uma
