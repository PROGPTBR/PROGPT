...
// design, adapted with 2B Supply brand colors (cyan #0ed1e0). Uses Inter
// (the single app typeface). This is a self-contained dark landing that
// does NOT cascade to the rest of the app.
//
// The plans in the "Planos" section are fetched server-side (see the
// server wrapper in app/page.tsx) so they always mirror /planos.
//
